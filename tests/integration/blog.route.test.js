...
const BlogModel = require('../../src/models/user.model');
const { 
  authoriseUser,
  createBlog,
...
, async () => {
    ...
    expect(response.body.blogs[0]).toHaveProperty('title', 'JavaScript Tutorial');
  });
});
...
describe('Blog: Get by Id', () => {
  it('should get a single blog', async () => {
    ...
    expect(response.body.blogData).toHaveProperty('title', 'JavaScript Tutorial');
  });
});
...
describe('Blog: Update Blog', () => {
  it('should update a blog', async () => {
    ...
    expect(response.body.blog).toHaveProperty('title', 'JavaScript Tutorial for Beginners');
